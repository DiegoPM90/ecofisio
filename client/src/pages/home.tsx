        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-semibold text-slate-900">MediCitas</h1>
            </div>
        ...
        <section id="inicio" className="text-center mb-12">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-slate-600 mb-8">
              Sistema inteligente de reservas con asistencia de IA para orientación médica
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                ...
                <p className="text-sm text-slate-600">Recibe orientación inicial sobre tu consulta</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                ...
                <p className="text-sm text-slate-600">Tu información médica protegida y confidencial</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-600 mb-4">
                Sistema inteligente de reservas médicas con asistencia de IA para una mejor atención sanitaria.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-slate-900 mb-4">Servicios</h3>
              <ul className="space-y-2 text-sm text-slate-600">
                <li><a href="#" className="hover:text-blue-600 transition-colors">Medicina General</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Especialidades</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Consultas Online</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Urgencias</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                ...
                <li>info@medicitas.com</li>
                <li>Calle Salud 123, Madrid</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-slate-200 mt-8 pt-8 text-center text-sm text-slate-600">
            <p>&copy; 2024 MediCitas. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
