...
// Ejecutar script de deploy para generar HTML completo
console.log('Ejecutando script de deploy...');
execSync('chmod +x deploy.sh && ./deploy.sh > /dev/null 2>&1', { stdio: 'pipe' });

// Leer el HTML generado o usar fallback
let htmlContent = '';
try {
    htmlContent = fs.readFileSync('dist/index.html', 'utf8');
} catch (error) {
    console.log('Usando HTML fallback con navegación completa...');
        ...
        <section class="text-center py-16">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="/status" class="bg-green-600 text-white px-8 py-4 rounded-lg text-lg font-medium inline-block">Estado de Citas</a>
                </div>
            </div>
        </section>
    </main>
